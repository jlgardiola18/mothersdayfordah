...
var w = c.width = window.innerWidth,
    ...
    opts = {
        strings: ['WISHING YOU', 'HAPPINESS & LOVE','MAMII DAH'],
        charSize: 30,
        charSpacing: 35,
        lineHeight: 40,
...
function createHeart() {
    ...
    // Random animation duration (faster)
    ...
    heart.style.transform = `translateX(${Math.random() * 50 - 25}px)`;
...
// Generate MORE hearts continuously
setInterval(() => {
    createHeart();
    createHeart();
}, 120);